...
long long gen_aluA()
{
    return (((((id_ex_curr->icode) == (I_ALU)) & ((ex_mem_curr->icode) == 
            (I_MRMOVQ))) & ((ex_mem_curr->destm) == (id_ex_curr->srca))) ? 
...
{
    return (((((id_ex_curr->icode) == (I_ALU)) & ((ex_mem_curr->icode) == 
            (I_MRMOVQ))) & ((ex_mem_curr->destm) == (id_ex_curr->srcb))) ? 
...
long long gen_e_valA()
{
    return (((((id_ex_curr->srca) == (ex_mem_curr->destm)) & (
            (ex_mem_curr->icode) == (I_MRMOVQ))) & ((id_ex_curr->icode) == 
          (I_RMMOVQ))) ? (mem_wb_next->valm) : (id_ex_curr->vala));
}
